...
export const TechniciansView: React.FC<TechniciansViewProps> = ({
  ...
  const safeUsers = useMemo(() => {
    ...
    if (currentUser?.role === 'TECHNICIAN') {
      return arr.filter(u => u.id === currentUser.id);
    }
    return arr;
  }, [users, currentUser]);
                ...
                >
                  ...
                  <td className="py-3.5 px-4 text-center">
                    {tech.role === 'TECHNICIAN' ? (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-full text-[11px] font-bold transition-all cursor-pointer disabled:cursor-default disabled:opacity-75 ${
                  ...
                  <td className="py-3.5 px-4 text-center">
                    <button
                      ...
                      disabled={currentUser?.role === 'TECHNICIAN'}
                      className={`px-2 py-1 rounded-lg text-[10px] font-bold transition-all inline-flex items-center space-x-1 cursor-pointer disabled:cursor-default disabled:opacity-75 ${
                        tech.mfaEnabled
                ...
                <div className="space-y-3.5 animate-fadeIn">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-900 focus:bg-white focus:ring-2 focus:ring-cyan-500 focus:outline-none disabled:opacity-75"
                    >
                      <option value="TECHNICIAN">Técnico de Campo (Acesso App, OS e Repasses Quinzenais)</option>
                      <option value="ADMIN">Administrador Master (Gestão Total, Diretoria e Configurações)</option>
                      <option value="OPERATIONAL">Gestão Operacional (Acompanhamento e Atribuição)</option>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-medium text-slate-900 read-only:opacity-75"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold text-slate-700 uppercase mb-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-mono text-slate-900 read-only:opacity-75"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                      ...
                      <input
                        ...
                        placeholder="Ex: 250, 100 ou 0"
                        className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm font-bold text-[#003366] focus:ring-2 focus:ring-cyan-500 focus:outline-none disabled:bg-slate-50 read-only:opacity-75"
                      />
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-900 focus:ring-2 focus:ring-cyan-500 focus:outline-none disabled:bg-slate-50 disabled:opacity-75"
                      >
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm font-bold text-amber-700 focus:ring-2 focus:ring-amber-500 focus:outline-none disabled:bg-slate-50 read-only:opacity-75"
                      />
                      <span className="text-[10px] text-slate-500 block">
                  ...
                  <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <label className="flex items-center space-x-2 text-xs font-bold text-slate-700 cursor-pointer">
                      <input
                        ...
                        className="rounded text-amber-600 focus:ring-amber-500 w-5 h-5 cursor-pointer disabled:opacity-50"
                      />
                                ...
                                <div className="inline-flex items-center space-x-1">
                                  ...
                                  <div className="relative w-24">
                                    ...
                                    <input
                                      ...
                                      className="w-full pl-6 pr-1 py-0.5 text-right font-mono font-bold text-slate-900 bg-white border border-slate-200 rounded text-xs focus:ring-1 focus:ring-emerald-500 disabled:opacity-75 disabled:bg-slate-50"
                                    />
                                  </div>
                                  {currentUser?.role !== 'TECHNICIAN' && (
                                  <button
